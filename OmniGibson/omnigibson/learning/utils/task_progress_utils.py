...
CHALLENGE_TASKS_PROGRESS_APPROXIMATION = {
    ...
    "assembling_gift_baskets": lambda env: check_progress(
        env,
        {
            ...
            # TODO: itertools.combinations implementation here?
        },
    ),
    ...
    "cook_cabbage": lambda env: check_progress(
        env,
        {
            ...
            "cabbage_diced": ("exists", "cooked__diced__head_cabbage.n.01_1", True),
            "chili_diced": ("exists", "cooked__diced__chili.n.01_1", True),
            "cabbage_in_pan": ("state", "cooked__diced__head_cabbage.n.01_1", Contains, "frying_pan.n.01_1", True),
            "chili_in_pan": ("state", "cooked__diced__chili.n.01_1", Contains, "frying_pan.n.01_1", True),
            "stove_on": ("state", "stove.n.01_1", ToggledOn, True),
            "cabbage_cooked": ("state", "head_cabbage.n.02_1", Cooked, True),
        },
    ),
    "chop_an_onion": lambda env: check_progress(
        env,
        {
            ...
            "onion_partially_chopped": ("exists", "diced__vidalia_onion.n.01_1", True),
            "onion_diced": ("exists", "diced__vidalia_onion.n.01_1", True),
            "diced_onion_in_bowl": ("state", "diced__vidalia_onion.n.01_1", Contains, "bowl.n.01_1", True),
    ...
    "slicing_vegetables": lambda env: check_progress(
        env,
        {
            ...
            "fridge_closed": ("state", "electric_refrigerator.n.01_1", Open, False),
            "veggies_on_boards": ("state", "bell_pepper.n.02_1", OnTop, "chopping_board.n.01_1", True),
            "parer_picked_up": ("state", "parer.n.02_1", OnTop, "countertop.n.01_1", False),
            ...
            "original_veggies_gone": ("exists", "bell_pepper.n.02_1", False),
        },
    ),
    "chopping_wood": lambda env: check_progress(
        env,
        {
            ...
            "all_logs_chopped": ("exists", "half__log.n.01_8", True),
            "axe_put_down": ("state", "ax.n.01_1", OnTop, "driveway.n.01_1", True),
        },
    ),
    ...
    "make_pizza": lambda env: check_progress(
        env,
        {
            ...
            "fridge_opened": ("state", "electric_refrigerator.n.01_1", Open, True),
            "tupperware_retrieved": ("state", "tupperware.n.01_1", Inside, "electric_refrigerator.n.01_1", False),
            "pepperoni_in_bowl": ("state", "pepperoni.n.01_1", Inside, "bowl.n.01_1", True),
            "mushrooms_chopped": ("exists", "mushroom.n.05_1", False),
            "toppings_on_dough": ("state", "pepperoni.n.01_1", OnTop, "pizza_dough.n.01_1", True),
            "cheese_on_pizza": ("state", "grated_cheese.n.01_1", OnTop, "pizza_dough.n.01_1", True),
